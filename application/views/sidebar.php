    <a href="<?php echo base_url(); ?>assets/index3.html" class="brand-link">
      <img src="<?php echo base_url(); ?>assets/dist/img/avatar.png" alt="avatar.png" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="?>assets/dist/img/afis.jpg" class="img-circle elevation-2" alt="user">
        </div>
        <div class="info">
